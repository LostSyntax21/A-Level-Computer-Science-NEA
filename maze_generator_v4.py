...
def generate_maze(rows, cols):
    ...
    while walls:
        # efficiently select and remove a random wall using swap-pop
        index = random.randint(0, len(walls) - 1)
        walls[index], walls[-1] = walls[-1], walls[index]
    ...
    # ensure entry and exit are opened
...
pygame.display.set_caption("Complex Perfect Maze Generator")
